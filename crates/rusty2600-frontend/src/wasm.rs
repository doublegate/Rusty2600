...
///
/// TODO(impl-phase): build the `App` (the native module shares the shell), create the wgpu surface
/// from the `<canvas>`, and drive the run loop with `requestAnimationFrame`.
///
/// # Errors
...
pub fn start() -> Result<(), JsValue> {
    ...
    web_sys::console::log_1(&"Rusty2600 wasm (scaffold) — frontend bootstrap TODO".into());
    Ok(())
}
