...
### T-0101-001 — Instruction-decode sequencer
...
- **Description:** replace the `Cpu::tick` stub with fetch/decode/execute; address
  ...
  real CPU cycle. (Closes `T-0101-001`.)
...
- **Dependencies:** T-0001-003. **Complexity:** L.

### T-0101-002 — All addressing modes + dummy reads
...
- **Dependencies:** T-0101-001. **Complexity:** L.

### T-0101-003 — Flags + stack + RESET timing
...
- **Dependencies:** T-0101-001. **Complexity:** M.

### T-0101-004 — Decimal mode (BCD ADC/SBC)
...
### T-0101-005 — Klaus functional 0-diff via the GoldenLogDiffer
...
- **Description:** bundle the Klaus functional-test golden trace, wire
  ...
  trace, and run the ROM to its success sentinel. (Closes `T-0601-001/002`.)
- **Acceptance:** `first_divergence()` returns `None` for the full functional-test
  run; the harness reports `Passed`.
- **Dependencies:** T-0101-002, T-0101-003, T-0101-004. **Complexity:** M.
